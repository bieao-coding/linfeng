	...
	carousel.fn = carousel.prototype = {
		...
		prev: function(parameter, pb_carousel, pb_carousel_ind, len){
			if(parameter.type == 'fade'){
				pb_carousel.eq(this.ind).fadeOut(1000);
				if(this.ind == 0) pb_carousel.eq(len - 1).fadeIn(1000);
				else pb_carousel.eq(this.ind).prev().fadeIn(1000);
				this.ind--;
		...
		next: function(parameter, pb_carousel, pb_carousel_ind, len){
			if(parameter.type == 'fade'){
				pb_carousel.eq(this.ind).fadeOut(1000);
				if(this.ind == len-1) pb_carousel.eq(0).fadeIn(1000);
				pb_carousel.eq(this.ind).next().fadeIn(1000);
				this.ind++;
		...
		click: function(carouselWrap, parameter){
			...
			pb_carousel_ind.click(function(){
				if($(this).index() != _this.ind){
					if(parameter.type == 'fade'){
						pb_carousel.eq(_this.ind).fadeOut(1000);
						_this.ind = $(this).index();
						pb_carousel.eq(_this.ind).fadeIn(1000);
					}else if(parameter.type == 'updown'){
